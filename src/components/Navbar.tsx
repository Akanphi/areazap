...
import { Search, MessageSquare, Bell, User, Settings, LogOut, ChevronDown, Menu as MenuIcon, X } from "lucide-react";
...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="z-50 flex items-center justify-between p-4 bg-linear-to-br from-slate-100 to-[#F8CACF] shadow-sm border-b border-white/20 backdrop-blur-sm relative">
        {/* MOBILE MENU BUTTON */}
        <button
          className="md:hidden mr-4 p-2 text-gray-600 hover:text-gray-900"
      ...
      {showMobileMenu && (
        <div className="fixed inset-0 z-[1001] md:hidden">
          ...
          {/* Sidebar Content */}
          <div className="absolute left-0 top-0 bottom-0 w-3/4 max-w-xs bg-white shadow-2xl p-4 animate-in slide-in-from-left duration-300">
