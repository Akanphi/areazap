...
export default function Login() {
    ...
    const handleSocialLogin = (provider: 'google' | 'github') => {
        ...
        const popup = openOAuthPopup(provider, 'login');
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full cursor-pointer  bg-[#1DD3C3] hover:bg-[#00E5CC] disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold py-3 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-2"
                        >
                            {isLoading ? (
